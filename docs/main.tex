...
Zadanie zostało wykonane w języku C++, ponieważ wspiera on programowanie obiektowe oraz posiada on gotowe struktury danych w ramach STL. Program został napisany z myślą o kompilacji w środowisku \textbf{GNU/Linux}. Wykorzystano system budowanie \textbf{CMake}. W ramach pracy zostały rozpatrzone następujące wersje zadania:
\begin{itemize}
\item jednowątkowa,
\item POSIX threads,
\item C++11 threads,
